...
public class GMKlijent {
    ...
    /**
     * Metda koja pomoću Google API-a na temelju geolokacijskih podataka uređaja
     * dohvaća njegovu adresu i vraća ju korisniku.
     *
     * @param latitude
     * @param longitude
     * @return
    ...
    public String getAddress(String latitude, String longitude) {
        ...
        String lokacija = latitude + "," + longitude;
        WebTarget webResource = client.target(GMRESTHelper.getGM_BASE_URI())
                .path("maps/api/geocode/json");
        webResource = webResource.queryParam("latlng", lokacija);
        ...
        String adresa = obj.getString("formatted_address");
